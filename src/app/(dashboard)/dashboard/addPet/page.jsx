...
const AddPetPage = () => {
    ...
    const date = new Date(); // ধরি আজকে 21 May 2026
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="md:col-span-2">
                        <TextField name="petName" isRequired>
                            <Label className='after:content-none'>Max</Label>
                    ...
                    <TextField name="breed" isRequired>
                        ...
                        <Input placeholder="Parcian" className="rounded-2xl" />
                        <FieldError />
                    </TextField>
                    ...
                    <TextField name="age" isRequired>
                        ...
                        <Input type='number' placeholder="3" className="rounded-2xl" />
                        <FieldError />
                    </TextField>
                    ...
                    <TextField name="location" isRequired>
                        ...
                        <Input placeholder="Dhaka, Mirpur" className="rounded-2xl" />
                        <FieldError />
                    </TextField>
